# Complete Gen I Character Map
# Based on the disassembly charmap.asm
...
CHARMAP = {
    ...
    0xE0: "'", 0xE1: "PK", 0xE2: "MN", 0xE3: "-", 0xE4: "'r", 0xE5: "♂",
    0xE6: "♀", 0xE7: "0", # E7 is zero but usually not used in names
    0xE8: ".", 0xE9: "z", 
    
    0xEF: "♂", # Used sometimes for symbol
    0xF0: "₽", # Pokédollar
